    ...
    <>
        ...
        <div className="container d-flex align-items-center justify-content-between">
          ...
          <div className="d-flex align-items-center gap-4">
            ...
            <div className="d-flex gap-4 fw-semibold navbar-menu">
              <Link to="/kadin" className="text-dark text-decoration-none">Kadın</Link>
              <Link to="/erkek" className="text-dark text-decoration-none">Erkek</Link>
              <Link to="/cocuk" className="text-dark text-decoration-none">Çocuk</Link>
            </div>
      ...
      <div className="py-3" style={{ backgroundColor: '#F8F8F8' }}>
        <div className="container d-flex justify-content-between fw-semibold navbar-submenu">
          <Link to="/ayakkabi" className="text-dark text-decoration-none">Ayakkabı</Link>
          <Link to="/spor" className="text-dark text-decoration-none">Spor</Link>
          <Link to="/giyim" className="text-dark text-decoration-none">Giyim</Link>
          <Link to="/canta-aksesuar" className="text-dark text-decoration-none">Çanta ve Aksesuar</Link>
          <Link to="/markalar" className="text-dark text-decoration-none">Markalar</Link>
          <Link to="/indirim" className="text-dark text-decoration-none">İndirim</Link>
          <Link to="/tum-kategoriler" className="text-dark text-decoration-none">Tüm Kategoriler</Link>
        </div>
      </div>
