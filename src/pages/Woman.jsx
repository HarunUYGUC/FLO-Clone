...
export default function Woman({ addToWishlist, addToBasket }) {
  ...
  useEffect(() => {
    const fetchMenProducts = async () => {
      try {
        ...
        console.error("Kadın giyim ürünleri alınırken hata oluştu:", err);
      } finally {
        setLoading(false);
      }
    };
  ...
  return (
    <div className="container my-5">
      ...
      <h1 className="text-center mb-4">Kadın Giyim Ürünleri</h1>
