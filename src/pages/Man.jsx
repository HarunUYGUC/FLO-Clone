...
export default function Man({ addToWishlist, addToBasket }) {
  ...
  useEffect(() => {
    const fetchMenProducts = async () => {
      try {
        ...
        console.error("Erkek giyim ürünleri alınırken hata oluştu:", err);
      } finally {
        setLoading(false);
      }
    };
  ...
  return (
    <div className="container my-5">
      ...
      <h1 className="text-center mb-4">Erkek Giyim Ürünleri</h1>
